        ...
        <div className="container container-wide pt-5 text-center">
          ...
          <div className="row my-5 pt-4">
            <div className="col-12 col-lg-4">
              ...
              />
              <h4>List</h4>
              <p>You create a listing of the shoe you want to sell.</p>
            </div>
            <div className="col-12 col-lg-4">
              <Img
              ...
              <h4>View</h4>
              <p>
                We promote your item on all our socials. A buyer views and
                purchases the item from our website.
              </p>
            </div>
            <div className="col-12 col-lg-4">
              <Img
              ...
              <h4>Win</h4>
              <p>
                You get paid directly into your account, ready to ship the shoes
                off to the buyer..
              </p>
            </div>
          </div>
          ...
          <div className="row my-5 pt-4">
            <div className="col-12 col-lg-4">
              ...
              />
              <h4>Find</h4>
              <p>Browse through hundreds of pairs and find your special one.</p>
            </div>
            <div className="col-12 col-lg-4">
              <Img
              ...
              />
              <h4>Buy</h4>
              <p>Purchase your crep with a few clicks of a button.</p>
            </div>
            <div className="col-12 col-lg-4">
              <Img
              ...
              />
              <h4>Win</h4>
              <p>The seller ships the trainers to you. Enjoy your new kicks!</p>
            </div>
          </div>
