          ...
          <div className="row">
            <div className="col-md-4">
              <p className="text-gray">
                We know it can be quite difficult nowadays to find sold out
                trainers you’ve been looking all around for, so we solve that
                problem and source them for you.
              </p>
              <h4>The Process is Simple:</h4>
              <p className="text-gray">
                You request an item, we find the item that has been requested
                and then we provide you with a quote for your item. The item
                will then be posted to the delivery address you give us once
                payment has been received and you’ll be updated with a tracking
                reference shortly after.
              </p>
              <p>
                We want you to have the best experience possible so we ensure
                that we provide fast response, competitive prices and a fast
                delivery time.
              </p>
            </div>
          ...
          <div className="row">
            {reviews.map(review => (
              <div className="col-6 col-sm-4 col-lg-3 mb-4">
                <Img fluid={review.childImageSharp.fluid} alt="" />
              </div>
            ))}
          </div>
        </div>
