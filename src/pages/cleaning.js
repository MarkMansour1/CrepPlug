                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <p className="text-gray">
                                Fill in the form with the details and photos of
                                the pair of sneakers you need cleaned. We will
                                get back to you ASAP with the treatment your
                                sneakers require.
                            </p>
                            <h4>Standard Treatment: £20</h4>
                            <p className="text-gray">
                                Our standard treatment includes a deep upper &
                                midsole clean and under-sole clean including
                                Jordans, Yeezys etc.
                            </p>
                            <h4>Premium Treatment: £25</h4>
                            <p className="text-gray">
                                Our premium treatment includes a deep upper &
                                midsole clean and under-sole clean including
                                luxury designer trainers such as Dior B22’s,
                                Balenciagas etc. Each initial order comes with a
                                pack of free shoe trees.
                            </p>
                        </div>
