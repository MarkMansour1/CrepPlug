...
const AccountSection = () => {
  ...
  useEffect(() => {
    fetch(
      `${process.env.GATSBY_SITE_URL}/wp-json/wc/v3/orders/${orderId}?consumer_key=${process.env.GATSBY_CONSUMER_KEY}&consumer_secret=${process.env.GATSBY_CONSUMER_SECRET}`,
      {
        headers: {
